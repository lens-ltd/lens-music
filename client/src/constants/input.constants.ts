...
export const ellipsisHClassName = `text-(--ink) cursor-pointer type-body-sm transition-colors duration-200 bg-(--surface) hover:bg-(--surface-hover) rounded-(--radius-control) p-1 px-3`;
