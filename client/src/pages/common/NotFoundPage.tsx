    ...
    >
      ...
      <section className="pb-18 md:pb-24">
        <article className="mx-auto max-w-4xl px-6 h-full min-h-[calc(100vh-64px)] flex items-center justify-center">
          <section className="rounded-2xl w-full border border-[color:var(--lens-sand)] bg-white/90 p-7 md:p-12 shadow-[0_20px_60px_-30px_rgba(16,14,9,0.25)]">
            ...
            <section className="mt-8 flex flex-col w-full sm:flex-row gap-3 sm:items-center">
              <Button route="#" onClick={(e) => {
                e.preventDefault();
                navigate(-1);
              }} className="px-6 py-2.5 text-[12px] tracking-[0.04em]">
                Back
              </Button>
              <Button primary route="/" className="px-6 py-2.5 text-[12px] tracking-[0.04em]">
                Explore
              </Button>
            </section>
